...
[Windows](https://wilsonl.in/hyperbuild/bin/0.0.22-windows-x86_64.exe) |
[macOS](https://wilsonl.in/hyperbuild/bin/0.0.22-macos-x86_64) |
[Linux](https://wilsonl.in/hyperbuild/bin/0.0.22-linux-x86_64)
...
Download the [JAR](https://wilsonl.in/hyperbuild/bin/0.0.22.jar) file.
...
Download the native module for [Windows](https://wilsonl.in/hyperbuild/bin/0.0.22-windows-x86_64-python.pyd), [macOS](https://wilsonl.in/hyperbuild/bin/0.0.22-macos-x86_64-python.so), or [Linux](https://wilsonl.in/hyperbuild/bin/0.0.22-linux-x86_64-python.so).
...
Download and install the [gem](https://wilsonl.in/hyperbuild/bin/0.0.22.gem).
